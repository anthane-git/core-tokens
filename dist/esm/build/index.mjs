...
const legacy = {
  ...
  "banner-border-default": "inset 0 0.0625rem 0 0 var(--core-border-neutral-subdued), inset 0 0 0 0.0625rem var(--core-border-neutral-subdued)",
  "banner-border-success": "inset 0 0.0625rem 0 0 var(--core-border-success-subdued), inset 0 0 0 0.0625rem var(--core-border-success-subdued)",
  "banner-border-highlight": "inset 0 0.0625rem 0 0 var(--core-border-highlight-subdued), inset 0 0 0 0.0625rem var(--core-border-highlight-subdued)",
  "banner-border-warning": "inset 0 0.0625rem 0 0 var(--core-border-warning-subdued), inset 0 0 0 0.0625rem var(--core-border-warning-subdued)",
  "banner-border-critical": "inset 0 0.0625rem 0 0 var(--core-border-critical-subdued), inset 0 0 0 0.0625rem var(--core-border-critical-subdued)",
  "thin-border-subdued": "0.0625rem solid var(--core-border-subdued)",
...
const shape = {
  ...
  "border-base": "var(--core-border-width-1) solid var(--core-border-subdued)",
  "border-dark": "var(--core-border-width-1) solid var(--core-border)",
  "border-transparent": "var(--core-border-width-1) solid transparent",
  "border-divider": "var(--core-border-width-1) solid var(--core-divider)",
  "border-divider-on-dark": "var(--core-border-width-1) solid var(--core-divider-dark)"
};
const spacing = {
  "space-0": "0",
  "space-025": "0.0625rem",
